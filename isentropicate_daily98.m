% isentropicate_dailymeans.m
% same as isentropicate.m except averages rawdata for the day before interpolation and calculation of diagnostics
%%%% START DATE
%yyyymmdd="20071214";
yyyymmdd="19980101";
...
p2isen='yes';
getbounds='yes';
savefilepath='/home/neil/data/daily/isentropic/';

isk=[300:3:350]';

% get indices for bounding surfaces of the isentropes given by isk

if strcmp(getbounds,'yes');[iup,idn]=boundingsurfaces_daily(yyyy,isk);
  else;load('-v6',['/home/neil/data/daily/isentropic/iup_idn_',num2str(yyyy),'.mat']);
endif
...
[lev,lat,lon,time6hr,hgt]=opennc(['/home/neil/data/6hourly/hgt/hgt.',num2str(yyyy),'.casesubset.nc'],'hgt');hgt=hgt+31265;
...
if strcmp(p2isen,'yes');[p_on_isen,sf]=pres2isen_daily(levm,air,hgt,iup,idn,isk,yyyy);writenc(yyyy,p_on_isen,lat,lon,isk,time,"isk","pk",savefilepath);
  else;load('-v6',['/home/neil/data/daily/isentropic/pres2isen',num2str(yyyy),'.mat']);
endif
% Interpolate VARIABLE to isentropic surface using method described in section 4.(b) of
% Shen et al., Mon.Wea.Rev.,1986.

%%%%%%%%% LOAD ALL VARIABLES
[lev,lat,lon,time6hr,uwnd]=opennc(['/home/neil/data/6hourly/uwnd/uwnd.',num2str(yyyy),'.casesubset.nc'],'uwnd');uwnd=uwnd*0.01+187.65;
[lev,lat,lon,time6hr,vwnd]=opennc(['/home/neil/data/6hourly/vwnd/vwnd.',num2str(yyyy),'.casesubset.nc'],'vwnd');vwnd=vwnd*0.01+187.65;
[lev,lat,lon,time6hr,rhum]=opennc(['/home/neil/data/6hourly/rhum/rhum.',num2str(yyyy),'.casesubset.nc'],'rhum');rhum=rhum*0.01+302.65;
[lev,lat,lon,time6hr,omega]=opennc(['/home/neil/data/6hourly/omega/omega.',num2str(yyyy),'.casesubset.nc'],'omega');omega=omega*0.001+28.765;
