function [iup,idn]=boundingsurfaces(yyyy,isk)
%
% function [iup,idn]=boundingsurfaces(yyyymmddhh,inc)
%
...
save('-v6',['/home/neil/data/6hourly/isentropic/iup_idn_',num2str(yyyy),'.mat'],'iup','idn','isk')
