function [p_on_isen,sf]=pres2isen_daily(p,t,gph,iup,idn,isk,yyyy)
%
% function [p_on_isen]=pres2isen_daily(p,t,gph,iup,idn)
%
...
save('-v6',['/home/neil/data/daily/isentropic/pres2isen',num2str(yyyy),'.mat'],'p_on_isen','sf')
